...
public class butunislemler_tab_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tab_butunislemler_hesap_ozeti, container, false);
        return rootView;
...
tv.setText(content);*/
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        for(int i = 0; i< Satim_Islemi_Fragment.butun_islemler.size(); i++){

            if(Satim_Islemi_Fragment.butun_islemler.get(i).getMiktar()>0 && Satim_Islemi_Fragment.butun_islemler.get(i).getMiktar() !=null) {
  ...
  protected void yeni_islem_olustur(int i){
      ...
      if(Satim_Islemi_Fragment.butun_islemler.get(i).getIslem_turu().equalsIgnoreCase("alis"))
      {
          ...
          tv_bilgi_maliyet_getiri.setText(String.valueOf(Satim_Islemi_Fragment.butun_islemler.get(i).getMaliyet()));
          ...
          tv_bilgi_maliyet_getiri.setText(String.valueOf(Satim_Islemi_Fragment.butun_islemler.get(i).getTl_degeri()));
          linearlayout_islem.setBackground(getResources().getDrawable(R.drawable.border2)); //İŞLEM TÜRÜNE GÖRE DEĞİŞMELİ !!!!

      }

      tv_bilgi_paraturu_txt.setText("Para Türü: ");
      tv_bilgi_paraturu.setText(Satim_Islemi_Fragment.butun_islemler.get(i).getpara_turu());


      tv_bilgi_miktar_txt.setText("Miktarı: ");
      tv_bilgi_miktar.setText(String.valueOf(Satim_Islemi_Fragment.butun_islemler.get(i).getMiktar()));



      tv_bilgi_tarih_txt.setText("İşlem Tarihi: ");
      tv_bilgi_tarih.setText(Satim_Islemi_Fragment.butun_islemler.get(i).getIslem_tarihi());
