...
public class satimislemleri_tab_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tab_satimislemleri_hesap_ozeti, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        for(int i=0;i<Satim_Islemi_Fragment.satim_islemi.size();i++){

            if(Satim_Islemi_Fragment.satim_islemi.get(i).getMiktar()>0 && Satim_Islemi_Fragment.satim_islemi.get(i).getMiktar() !=null) {
    ...
    protected void yeni_islem_olustur(int i){
        ...
        if(Satim_Islemi_Fragment.satim_islemi.get(i).getIslem_turu().equalsIgnoreCase("alis"))
        {
            ...
            tv_bilgi_maliyet_getiri.setText(String.valueOf(Satim_Islemi_Fragment.satim_islemi.get(i).getMaliyet()));
        }
        else {
            ...
            tv_bilgi_maliyet_getiri.setText(String.valueOf(Satim_Islemi_Fragment.satim_islemi.get(i).getTl_degeri()));
        }

        tv_bilgi_paraturu_txt.setText("Para Türü: ");
        tv_bilgi_paraturu.setText(Satim_Islemi_Fragment.satim_islemi.get(i).getpara_turu());


        tv_bilgi_miktar_txt.setText("Miktarı: ");
        tv_bilgi_miktar.setText(String.valueOf(Satim_Islemi_Fragment.satim_islemi.get(i).getMiktar()));



        tv_bilgi_tarih_txt.setText("İşlem Tarihi: ");
        tv_bilgi_tarih.setText(Satim_Islemi_Fragment.satim_islemi.get(i).getIslem_tarihi());
